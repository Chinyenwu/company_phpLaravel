    ...
    <div class="col-sm-8 offset-sm-2">
        ...
        <form method="post" action="{{ route('activities.update', $activity->id) }}">
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="brief" value={{ $activity->brief }}/>
          </div>   
          <div class="form-group">    
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="type" value={{ $activity->type }}/>
          </div>
            <div class="form-group">    
              <label for="start_date">起始日期:</label>
              <input type="text" class="form-control" name="start_date" value={{ $activity->start_date }}/>
          </div>
          <div class="form-group">    
              <label for="end_date">結束日期:</label>
              <input type="text" class="form-control" name="end_date" value={{ $activity->end_date }}/>
          </div>  
          <div class="form-group">    
          ...
          <div class="form-group">    
              ...
              <input type="text" class="form-control" name="remark" value={{ $activity->remark }}/>
          </div> 
